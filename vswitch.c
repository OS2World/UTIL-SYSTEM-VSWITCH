...
static void near draw_list(PSWBLOCK pswb, USHORT usWidth, USHORT usHeight, USHORT usSelection) /*SJD Wed  08-12-1992  22:20:37 */
{
  ...
  abCell[0]='É';  VioWrtNCell(abCell, 1, usTop, usLeft, 0);
  abCell[0]='Í';  VioWrtNCell(abCell, usMenuWidth-2, usTop, usLeft+1, 0);
  ...
  for (i=0; i < pswb->cswentry; i++)
  {
    ...
    bAttr=ATTR_NORMAL;
    VioWrtCharStrAtt("º", 1, usTop, usLeft, &bAttr, 0);
    ...
    bAttr=ATTR_NORMAL;
    VioWrtCharStrAtt("º", 1, usTop, usLeft+usMenuWidth-1, &bAttr, 0);
  ...
  abCell[0]='È';  VioWrtNCell(abCell, 1, usTop, usLeft, 0);
  abCell[0]='Í';  VioWrtNCell(abCell, usMenuWidth-2, usTop, usLeft+1, 0);
  abCell[0]='¼';  VioWrtNCell(abCell, 1, usTop, usLeft+usMenuWidth-1, 0);
